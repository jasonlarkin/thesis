...
\nomenclature[A]{BTE}{Boltzmann transport equation}
By fitting the
...
\nomenclature[A]{CH}{Callaway-Holland}
...
\nomenclature[A]{ALD}{anharmonic lattice dynamics}
...
\nomenclature[A]{AF}{Allen-Feldman}
...
\nomenclature[A]{NMD}{normal mode decomposition}
...
\nomenclature[A]{BZ}{Brillouin zone}
...
Efficient MD 
codes like LAMMPS
\nomenclature[A]{LAMMPS}{Large-scale Atomic/Molecular Massively Parallel Simulator}
