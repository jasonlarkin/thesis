...
Regner et al.\cite{regner_broadband_2013}  
...
\nomenclature[A]{MFP}{mean free path}
...
feldman_numerical_1999,liu_high_2009,yang_anomalously_2010,
he_heat_2011}
\nomenclature[V]{$k_{vib}$}{total vibrational thermal conductivity}
\nomenclature[V]{$k_{pr}$}{propagating component of total vibrational thermal conductivity}
...
\nomenclature[G]{$\omega_{cut}$}{propagating to non-propagating cut-off frequency}
\nomenclature[V]{$C(\omega)$}{vibrational mode specific heat}
\nomenclature[V]{$D_{pr}$}{propagating mode diffusivity}
...
\nomenclature[G]{$\Lambda$}{propagating mode mean free path}
...
\nomenclature[V]{$S_{ij}$}{heat current operator}
\nomenclature[G]{$\delta$}{dirac delta function}
...
\nomenclature[A]{BKS}{Beest-Kramer-van Santen}
...
\nomenclature[A]{WWW}{Wooten-Winer-Weaire}
...
%--------------------------------------------------------------------------
%\clearpage
\nomenclature[A]{VESTA}{Visualization for Electronic and Structural Analysis}
%\vspace{50mm}
%--------------------------------------------------------------------------
...
%\nomenclature[G]{$\omega_0(\pmb{\kappa})$}{structure factor peak frequency locations}
%\nomenclature[G]{$\Gamma(\pmb{\kappa})$}{structure factor peak linewidths}
\nomenclature[G]{$\kappa_{max}$}{maximum wavevector for structure factor analysis}
\nomenclature[V]{$C_0(\pmb{\kappa})$}{structure factor peak constant}
...
\nomenclature[V]{$G$}{bulk modulus}
\nomenclature[V]{$K$}{shear modulus}
...
\nomenclature[V]{$v_{s,DOS}$}{sound speed extracted from the DOS}
...
\nomenclature[G]{$\Lambda_{AF}$}{diffuson mean free path}
\nomenclature[V]{$v_{AF}$}{diffuson velocity scale}
...
\end{figure}
\nomenclature[G]{$\Lambda_{HS}$}{high scatter mean free path}
%--------------------------------------------------------------------------
% \clearpage
...
yang_anomalously_2010,
he_heat_2011,regner_broadband_2013}
\nomenclature[G]{$\tau_{eff}$}{effective vibrational lifetime}
...
Figs. \ref{FIG:sio2_accum}(a) and \ref{FIG:sio2_accum}(b).}  
\nomenclature[G]{$\Lambda_{cut}$}{mean free path at the cut-off frequency}
\nomenclature[V]{$k(\Lambda^{*})$}{thermal conductivity accumulation function}
\nomenclature[G]{$\Lambda^*$}{maximum mean free path considered in the thermal conductivity accumulation}
\nomenclature[V]{$k(\Lambda)$}{thermal conductivity as a function of mean free path}
