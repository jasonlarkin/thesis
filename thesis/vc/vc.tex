...
silicon. 
\nomenclature[A]{VC}{virtual crystal}
...
\nomenclature[A]{VC-ALD}{anharmonic lattice dynamics performed using 
...
and lifetime $\tau\kv$. 
\nomenclature[V]{$k_{ph,\mathbf{n}}$}{phonon thermal conductivity in the direction $\mathbf{n}$}
...
\nomenclature[V]{$k_{AF}$}{diffuson thermal conductivity}
\nomenclature[V]{$D_{AF,i}$}{mode diffusivity of the $i$th diffuson}
\nomenclature[G]{$\omega_i$}{frequency of the $i$th diffuson}
...
\nomenclature[V]{$v_s$}{sound speed}
\nomenclature[V]{$V_b$}{volume of the unit cell}
\nomenclature[A]{HS}{high scatter}
\nomenclature[V]{$k_{HS}$}{high scatter thermal conductivity}
...
\nomenclature[V]{$m^i$}{mass of the $i^{th}$ species}
%\nomenclature[P]{$i$}{$i^{th}$ species}
\nomenclature[V]{$c$}{alloy concentration}
...
\nomenclature[A]{$NPT$}{constant number of atoms, pressure, and temperature ensemble}
\nomenclature[V]{$P$}{pressure} 
...
NMD and GK methods. 
\nomenclature[A]{$NVT$}{constant number of atoms, system volume, and temperature ensemble}
...
\nomenclature[A]{Gamma}{analysis at the Gamma point (i.e., $\pmb{\kappa}=0$)}
\nomenclature[A]{Gamma-NMD}{normal mode decomposition performed at the Gamma point (i.e., $\pmb{\kappa}=0$)}
\nomenclature[A]{DOS}{density of states}
...
\nomenclature[G]{$\pmb{\kappa}_{VC}$}{allowed wavevector of the virtual crystal}
\nomenclature[G]{$\hat{\pmb{\kappa}}_{VC}$}{unit vector of the allowed wavevector of the virtual crystal}
\nomenclature[V]{$S^{L,T}\kvcw$}{longitudinal and transverse structure factor}
\nomenclature[V]{$E^L\kvcv$}{longitudinal and transverse mode spectra}
...
\nomenclature[G]{$\delta_{\omega,avg}$}{average frequency spacing}
...
\nomenclature[V]{$u_{\alpha}$}{$\alpha$-component of the atomic displacement 
from equilibrium}
\nomenclature[V]{$\dot{u}_{\alpha}$}{$\alpha$-component of the atomic velocity} 
...
\nomenclature[V]{$t^*$}{upper limit of time integration} 
...
\nomenclature[A]{VC-NMD}{normal mode decomposition performed using the virtual crystal approximation} 
...
\nomenclature[G]{$\tau_{p-p}\kv$}{phonon-phonon scattering lifetime} 
\nomenclature[G]{$\tau_{p-d}\kv$}{phonon-defect scattering lifetime} 
...
$m^i_{1-c}$.
\nomenclature[V]{$m^\mu$}{mass of the $\mu$-th species}
\nomenclature[V]{$c^\mu$}{concentration of the $\mu$-th species}
\nomenclature[V]{$\bar{m}^{\mu}$}{average mass of the $\mu$-th species}
...
\nomenclature[V]{$g_n$}{disorder strength of the $n^{th}$ order process of the Tamura theory}
...
\nomenclature[V]{$D_{ph,\mathbf{n}}\kv$}{phonon diffusivity in the direction $\mathbf{n}$}
...
\nomenclature[V]{$D_{HS}$}{high scatter diffusivity}
\nomenclature[V]{$D_{IR}$}{Ioffe-Regel diffusivity}
...
\ref{S:SW}.
\nomenclature[V]{$k_{GK}$}{Green-Kubo predicted thermal conductivity}
...
\nomenclature[V]{$k_{bulk}$}{bulk thermal conductivity}
...
\nomenclature[V]{$c_0$}{bulk thermal conductivity constant} 
...
% \nomenclature[A]{$k_{VC-ALD}$}{VC-ALD predicted thermal conductivity}
% \nomenclature[A]{$k_{VC-NMD}$}{VC-NMD predicted thermal conductivity}
