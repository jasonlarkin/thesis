...
\nomenclature[A]{$H$}{system Hamiltonian} 
\nomenclature[V]{$T\kvt$}{normal mode kinetic energy}
\nomenclature[V]{$V\kvt$}{normal mode potential energy} 
The
...
\nomenclature[V]{$S_{D}(\pmb{\kappa},\omega)$}{displacement structure factor} 
...
{Primitive}\newline 
\includegraphics[scale=0.2]{/home/jason/thesis/thesis/lj_ucell_prim.eps} 
& \href{https://github.com/jasonlarkin/disorder/blob/master/matlab/gulp_disp_lj_conv.tmp}
{Conventional}
\newline \includegraphics[scale=0.2]{/home/jason/thesis/thesis/lj_ucell_conv.eps} 
& \href{https://raw.github.com/jasonlarkin/disorder/master/lj/alloy/10K/0.0/4x/GK/lmp.in.x0.1}
{Gamma} (Supercell)
\newline \includegraphics[scale=0.2]{/home/jason/thesis/thesis/lj_sucell_conv.eps}\\
\hline
Basis
& 1 atom 
& 4 atoms
...
\includegraphics[scale=0.18]{/home/jason/thesis/thesis/lj_octahedron.eps} 
& Cube \newline 
\includegraphics[scale=0.18]{/home/jason/thesis/thesis/lj_cubic.eps}
& Cube \newline 
\includegraphics[scale=0.18]{/home/jason/thesis/thesis/lj_cubic_super.eps}\\ \hline
Number of \newline Wave Vectors
& 256 
& 64
& 1\\ \hline
...
%--------------------------------------------------------------------------
\subsection{\label{A:unitcell}Unit Cell Representations using 
...
The lifetimes predicted from the frequency-domain analysis ($\Phi$) 
...
%according to the parity relation [Eq. \eqref{EQ:kpt_sym}] 
...
While one could perform the NMD for an alloy by projecting 
...
% The lifetimes predicted from the VC-NMD method 
...
\nomenclature[V]{$k(N_0)$}{system size-dependent thermal conductivity} 
...
For the LJ argon alloys, the requirements for Eq. \eqref{EQ:A:k0} 
...
For the LJ amorphous phase, a frequency dependent broadening does not 
